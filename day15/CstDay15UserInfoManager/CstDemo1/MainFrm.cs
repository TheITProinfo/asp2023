...
namespace CstDemo1
{
    public partial class MainFrm : Form
    {
       ...
       private int updateUserID = 0;
        ...
        /// <summary>
        /// 
        /// load all user data to griddataview
        /// </summary>
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
           // MessageBox.Show("data deleted!");
            ...
            {
                MessageBox.Show("please select al least one row");
            }
        ...
        private void dgvUserInfo_SelectionChanged(object sender, EventArgs e)
        {
            ...
            // copen database, get userinfo by selectRowID
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            LoadUserInfos();//refresh record after updata
        }
